...
Style specifications may be applied to common-canvas objects using the following <Link to="/common-canvas/canvas-controller/canvas-controller-api">Canvas Controller</Link> methods:
