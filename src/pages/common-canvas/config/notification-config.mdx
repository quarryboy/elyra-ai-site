...
For information about the structure of notification messages, refer to the <a href="#notification-config-object">message specification documentation</a>. Notification messages can be added and removed from the notification panel by calling the canvas controller API. Refer to the canvas controller API documentation for information on how to <a href="/common-canvas/canvas-controller/canvas-controller-api#notification-messages-methods">add/set messages in the notification message array</a>.
